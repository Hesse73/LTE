...
# -*- coding: utf-8 -*-
"""
Created on Tue May 25 10:57:11 2021
...
class GMMTransformer(object):
    """
    这里的n_cluster不同于后面的聚类中心个数，这里指的是GMM的聚类mode个数
    """

    def __init__(self, n_clusters=8, epsilon=0.0005):
    ...
    def _transform_continuous(self, column_meta, data):
        ...
        #print([features.shape, probs_onehot.shape])
